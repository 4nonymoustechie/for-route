        ...
        <>
         <div className="sidebar">
                <ul>
                    ...
                    <li> <Link to = "/dashboard/users/project"className="sidebar-list-item" href="#0"> <i className="fas fa-tasks icon"></i><em>Projects</em></Link></li>
                    <li> <Link to = '/dashboard/users/project/events' className="sidebar-list-item active" href="#0"> <i className="fas fa-calendar icon"></i><em>Events</em></Link>
                    </li>
                    <li> <Link to = "/dashboard/users/project/events/preferances"className="sidebar-list-item" href="#0"> <i className="fas fa-toolbox icon"></i><em>Preferences</em></Link>
                    </li>
